...
//entry for Condition resource: No family history of malignancy: Joint clinic notes:  Adult Hematolymphoid: Family history section
* entry[+].fullUrl = "urn:uuid:a9fac67b-0cf5-4988-af3c-cc8b2aac348b"
* entry[=].resource = a9fac67b-0cf5-4988-af3c-cc8b2aac348b
...
* entry[+].fullUrl = "urn:uuid:08bfa121-dbc4-445a-95f9-6f9f5bc5d4a47"
...
* section[=].entry[0] = Reference(urn:uuid:5c8f4572-7e4b-421a-87bc-7fa4dcd05f6a)
* section[=].entry[=].type = "Observation"
// Observation for PET-CT Scan: Adult Hematolymphoid: Joint clinic notes: Observation section
* section[=].entry[0] = Reference(urn:uuid:3a4d9e57-4b9f-47b7-9c6e-3a9f58a5671d)
* section[=].entry[=].type = "Observation"
// Observation for Pregnancy Status: Adult Hematolymphoid: Joint clinic notes: otherObservation section
...
* section[=].entry[0] = Reference(urn:uuid:a9fac67b-0cf5-4988-af3c-cc8b2aac348b)
* section[=].entry[=].type = "Condition"
...
* section[=].entry[0] = Reference(urn:uuid:3e7a2561-5f4b-4d2c-957d-9c4e20d9b798)
* section[=].entry[=].type = "MedicationAdministration"

// Section for CarePlan
* section[+].title = "Care Plan"
* section[=].code = $loinc#18776-5 "Care Plan" 
...
* subject = Reference(urn:uuid:c4d052b5-2d9f-4ebf-b617-764efffa08de)
* subject.type = "Patient"
* outcome = $sct#17621005 "Negative"  // Outcome indicating no involvement
...
* valueCodeableConcept = $sct#252465000 "Atypical cells, suspected NHL involvement"
...
* meta.profile = "https://nrces.in/ndhm/fhir/r4/StructureDefinition/Procedure"
* status = #completed
* code = $sct#13751005 "ISRT to 45 Gy in 25 fractions"
...
* status = #active
* intent = #plan
* category = $sct#386053000 "OBG consultation for comprehensive care"
...
* subject = Reference(urn:uuid:c4d052b5-2d9f-4ebf-b617-764efffa08de) "John Doe"  // Replace with the actual patient reference
* subject.type = "Patient"
* occurrenceDateTime = "2021-12-24T00:00:00Z"  // Provisional Start Date
* requester = Reference(urn:uuid:41295111-04f9-4b83-b186-ef2975db1c7e) "Dr. Smith"  // Replace with the actual requester reference
