...
//entry for Observation resource(Chief Complaint: Palpable mass of breast)
...
// entry for ServiceRequest resource(Plan)
...
//section entry for Observation resource(Chief Complaint: Palpable mass of breast)
...
//section entry for ServiceRequest resource(Plan)
...
* meta.profile = "https://nrces.in/ndhm/fhir/r4/StructureDefinition/Observation"
* status = #final
* code = $sct#289908002 "Postmenopausal"
* code.text = "Menopause status"
* subject = Reference(urn:uuid:c4d052b5-2d9f-4ebf-b617-764efffa08de) "Meera Sharma"
* subject.type = "Patient"
...
Usage: #inline
* meta.versionId = "0"
* meta.lastUpdated = "2024-11-07T12:18:11.143+05:30" // Replace with actual timestamp
...
* condition[0].code.text = "Family history of breast cancer"
...
* type[0] = $sct#185349003 "General examination by physician"
* subject = Reference(urn:uuid:c4d052b5-2d9f-4ebf-b617-764efffa08de) "Meera Sharma"
* subject.type = "Patient"
...
// Observation Resource (Chief Complaint: Palpable mass of breast)
Instance: 216861b1-ca70-41bc-be26-d5b0994a700b
InstanceOf: Observation
Usage: #inline
* meta.versionId = "0"
* meta.lastUpdated = "2023-10-10T09:15:00+05:30"
* meta.profile = "https://nrces.in/ndhm/fhir/r4/StructureDefinition/Observation"
* status = #final
...
* subject = Reference(urn:uuid:c4d052b5-2d9f-4ebf-b617-764efffa08de) "Meera Sharma"
* subject.type = "Patient"
* effectiveDateTime = "2023-10-10T09:15:00+05:30"
* valueString = "Palpable lump in the right breast, noticed 2 weeks ago"
...
* component[5].code = $loinc#39156-5 "Body mass index (BMI)"
...
// ServiceRequest resource for Plan
